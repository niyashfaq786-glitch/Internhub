    ...
    for (const row of rows) {
      try {
        ...
        try {
          ...
          // If email already exists, you might be re-uploading.
          // In that case, we cannot fetch UID from client easily.
          // Best beginner approach: delete the old Auth user in Firebase Console, then re-upload.
